...
from smolvla_pipeline import SmolVLAInferencePipeline
...
def main():
    ...
    DATASET_NAME = "smolvla_stacking_action_chunks"
    stacking_dataset = "lerobot/svla_so100_stacking"

    pipeline = SmolVLAInferencePipeline(
        policy_repo_id=DEFAULT_MODEL,
