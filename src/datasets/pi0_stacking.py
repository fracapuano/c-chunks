...
from pi0_pipeline import PI0InferencePipeline
...
def main():
    ...
    DATASET_NAME = "pi0_stacking_action_chunks"
    stacking_dataset = "lerobot/svla_so100_stacking"

    pipeline = PI0InferencePipeline(
        policy_repo_id=DEFAULT_PI0_MODEL,
    ...
    hf_data = prepare_hf_dataset_data(all_data)
